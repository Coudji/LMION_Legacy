return {
    ...
    defaults = {
        ...
        construction = { skill = { Woodwork = 5 }, time = 120, xp = 25, tools = { "Base.Hammer" }, materials = { { item = "Base.Plank", amount = 4 }, { item = "Base.Nails", amount = 4 }, { item = "Base.Hinge", amount = 2 }, { item = "Base.Doorknob", amount = 1 } } },
        pickup = { skill = { Woodwork = 2 }, tools = { "Base.Hammer" }, breakChance = 0, packages = { count = 1, weight = 15 } },
