...
Status: **Bytecode-verified B42.20.3; Pickup implementation open**
...
N: industry_trucks_01_35 industry_trucks_01_36 industry_trucks_01_37
```

The resulting dimensions are therefore `1x3` for W and `3x1` for N.

This matches the Java topology above: three physical members with logical indices `1..3`.
